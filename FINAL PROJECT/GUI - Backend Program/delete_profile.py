...
def main2():
    ...
    def custom_show_error2(message):
        error_dialog = tk.Toplevel()
        error_dialog.title("Error")
        error_dialog.geometry("300x100")
    ...
    def combined_commands():
        ...
        deleteprofile_boxbg()
        custom_show_error2("Deleted.")
        deleteprofile_boxbg()
        error_dialog.destroy

    def deleteprofile_boxbg():
        error_dialog.destroy
        pass
    ...
    def custom_show_error(message):
        ...
        no_button = tk.Button(button_frame, text="No", command=error_dialog.destroy)
        no_button.pack(side=tk.RIGHT, padx=10, pady=10)

        ok_button = tk.Button(button_frame, text="Yes", command=combined_commands)
    ...
    def main_interface():
        ...
        text_reports = tk.Label(top_frame, text="Delete Profile", font=("Helvetica", 16), bg='#333333', fg="white")
    ...
    def load_profile():
        ...
        if employee_data is not None:
            ...
            show_notfound("No employee found with the provided ID.")
    ...
    def input_boxes():
        ...
        # Employee ID
        add_em_button = tk.Button(window, text="DELETE PROFILE", fg="white", height=2, width=20, command=addprofile_boxbg, background="red")
        add_em_button.pack()
    ...
    def view_button():
        ...
        view_button = tk.Button(window, text="CHECK", fg="white", height=1, width=20, command=load_profile_from_entry, background="Black")
        view_button.pack()
    ...
    def addprofile_boxbg():
        ...
        custom_show_error("Delete Profile?")
    ...
    def deleteprofile_boxbg():
        ...
        # Retrieve the values from the entry widgets
        db.employee_delete2(em_id)

    def editprofile_box():
        global view_firstname, view_lastname, view_age, view_birthday, view_gender, view_address, view_contactnum, view_email, view_jobstatus
        # Report Slip Name Label na Malaki
        big_text = tk.Label(window, text="Delete Profile", font=("Helvetica", 36, "bold"), bg="lightgrey")
        big_text.place(relx=0.244, rely=0.12, anchor=tk.CENTER)
